...
images="$(docker image ls ros1 | grep ros1)"

if [[ "${images}" == "" ]]; then
    echo 'ros1 のDockerイメージが見つかりませんでした．'
...
DOCKER_VOLUME="${DOCKER_VOLUME} -v ${HOST_WS}:/home/ros1/catkin_ws:rw"
DOCKER_VOLUME="${DOCKER_VOLUME} -v ${HOST_SD}:/home/ros1/shared_dir:rw"
